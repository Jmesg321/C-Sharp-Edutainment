...
public class LSUIController : MonoBehaviour
{
    ...
    public Text levelName, energyFound, energyTarget, bestTime, timeTarget;
    ...
    public void ShowInfo(MapPoint levelInfo)
    {
        ...
        energyFound.text = "FOUND: " + levelInfo.energyCollected;
        energyTarget.text = "IN LEVEL: " + levelInfo.totalEnergy;
